...
usePageSeo({
  ...
  description: 'Все 50+ бассейнов Ташкента на интерактивной карте. Найдите ближайший бассейн по адресу, узнайте цены и расписание. Кликните на маркер для деталей.',
  canonical: '/map',
})
</script>
