...
usePageSeo({
  title: 'Карта бассейнов Ташкента и Узбекистана — найти ближайший 2026 | Basen.uz',
  description: 'Все бассейны Ташкента и Узбекистана на интерактивной карте. Найдите ближайший бассейн, посмотрите цены, расписание и адрес.',
  canonical: '/map',
})
</script>
