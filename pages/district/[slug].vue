...
const districtSeoTextMap: Record<string, string> = {
  ...
  almazar: 'Олмазорский район — один из районов Ташкента, где каталог Basen.uz пока пополняется: актуальных бассейнов с полными данными здесь на данный момент нет. Если вы знаете бассейн в этом районе или являетесь его владельцем — напишите нам в Telegram, и мы добавим объект в каталог. А пока стоит заглянуть в соседние Чиланзарский или Юнусабадский районы — там представлен более широкий выбор открытых и крытых бассейнов.',
}
