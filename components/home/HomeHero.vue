<template>
  <section
    class="relative overflow-hidden bg-gradient-to-br from-primary-700 via-primary-800 to-primary-900"
  >
    <!-- Decorative blobs -->
    <div
      class="absolute -top-32 -right-32 w-[28rem] h-[28rem] bg-aqua-500/20 rounded-full blur-3xl pointer-events-none"
    />
    <div
      class="absolute -bottom-20 -left-20 w-80 h-80 bg-primary-500/20 rounded-full blur-3xl pointer-events-none"
    />
    <div
      class="absolute top-1/2 right-1/4 w-48 h-48 bg-aqua-400/10 rounded-full blur-2xl pointer-events-none"
    />
    ...
    <div class="container relative z-10 py-16 sm:py-24">
      <div class="max-w-2xl mx-auto text-center">
        <!-- Live badge -->
        <div
          class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/15 border border-white/20 text-white/90 text-sm mb-6"
        >
          <span
        ...
        <h1
          class="text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight mb-4"
        >
          {{ $t("home.hero_title") }}
        </h1>
        ...
        <div class="relative max-w-lg mx-auto mb-8" ref="searchWrap">
          <div
            class="flex bg-white rounded-2xl shadow-2xl overflow-hidden ring-2 ring-white/20"
          >
            <input
              v-model="query"
              type="text"
          ...
          <Transition name="dropdown">
            ...
            >
              ...
              >
                <div
                  class="w-8 h-8 rounded-lg bg-primary-100 flex items-center justify-center shrink-0"
                >
                  <svg
                ...
                <svg
                  class="w-4 h-4 text-gray-300 group-hover:text-primary-400 transition-colors ml-auto shrink-0"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path
        ...
        <NuxtLink
          ...
          class="inline-flex items-center gap-2 text-white text-sm font-medium transition-colors duration-150"
        >
      ...
      <!-- Stats -->
      <div
        class="mt-14 flex justify-center items-center gap-8 sm:gap-16 flex-wrap"
      >
