    ...
    <div class="container py-10">
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-8">
        ...
        <div>
          <NuxtLink :to="localePath('/')" class="flex items-center gap-2 mb-3">
            <div class="w-8 h-8 rounded-xl bg-white/10 flex items-center justify-center">
              <svg class="w-5 h-5 text-aqua-400" viewBox="0 0 24 24" fill="currentColor">
            ...
            <span class="text-lg font-bold">Basen<span class="text-aqua-400">.uz</span></span>
          </NuxtLink>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li>
              <NuxtLink :to="localePath('/about')" class="text-sm text-primary-200 hover:text-white transition-colors duration-150">
                {{ $t('about.title') }}
              </NuxtLink>
            </li>
            <li>
              <NuxtLink :to="localePath('/faq')" class="text-sm text-primary-200 hover:text-white transition-colors duration-150">
                {{ $t('faq.title') }}
              </NuxtLink>
            </li>
          </ul>
      ...
      <div class="mt-8 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3">
        <p class="text-xs text-primary-300">
          © {{ currentYear }} Basen.uz — {{ $t('about.meta_desc').slice(0, 50) }}…
        </p>
